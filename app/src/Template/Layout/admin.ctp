        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">                    
                    <li>
                        <a href="/admin/users/add"><i class="fa fa-fw fa-user"></i> Add users</a>
                    </li>
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="/admin/posts/index"><i class="fa fa-fw fa-user"></i>Danh sách bài viết</a>
                            </li>
                            <li>
                                <a href="/admin/posts/add"><i class="fa fa-fw fa-user"></i>Tạo mới bài viết</a>
                            </li>
                        </ul>
                    </li>
                </ul>
